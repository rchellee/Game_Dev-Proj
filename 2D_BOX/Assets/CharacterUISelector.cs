...
public class CharacterUISelector : MonoBehaviour
{
    ...
    private void Start() {
        foreach (Character c in GameManager.instance.characters) {
            ...
            // Textmesh text = option.GetComponentInChildren<Text>();
            // text.text = c.name;
    ...
    private void Update() {
        ...
        if (prevCharacter != null) {
            prevCharacter.localScale = Vector3.Lerp(prevCharacter.localScale, new Vector3
            (1f, 1f, 1f), Time.deltaTime * 10);
        }
    }
}
